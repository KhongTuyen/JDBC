 ...
 * @author hoang
 */
public class QuanLyXeTaiUI extends javax.swing.JFrame {
    private ArrayList<Vehicle> list;
    DefaultTableModel model;
    /**
     * Creates new form QuanLyXeTaiUI
     */
    public QuanLyXeTaiUI() {
        initComponents();
    this.setLocationRelativeTo(null);
        list = new ConnectDB().showXeTai();
        model = (DefaultTableModel) tbl_XeTai.getModel();
        model.setColumnIdentifiers(new Object[]{
            "Ma Phuong Tien","Ten Phuong Tien","Hang San Xuat","Loai Phuong Tien","Nam San Xuat","Gia","Mau","Trong Tai"
        });
        showTableXeTai();
    }
    public void showTableXeTai(){
        for(Vehicle v:list){
            model.addRow(new Object[]{
                v.getVehicleId(),v.getVehicleName(),v.getMaker(),v.getVehType(),v.getYear(),v.getUnitPrice(),v.getColor(),v.getTonnage()
            });
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        tbl_XeTai = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setText("QUAN LY XE TAI");
        ...
        tbl_XeTai.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tbl_XeTai);
    ...
    private void btn_TimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_TimKiemActionPerformed
        ...
        try{
            ...
            Vehicle v = cn.findXeTaiById(txt_MaPT.getText());
    ...
    public void showData(List<Vehicle> v){
        ...
        tbl_XeTai.getModel();
        tableModel=(DefaultTableModel)tbl_XeTai.getModel();
        tableModel.setRowCount(0);
        listVehicle.forEach((vehicle)->{
            tableModel.addRow(new Object[]{
                vehicle.getVehicleId(),vehicle.getVehicleName(),vehicle.getMaker(),vehicle.getVehType(),vehicle.getYear(),vehicle.getUnitPrice(),vehicle.getColor(),vehicle.getTonnage()
            });
        });
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyXeTaiUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyXeTaiUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbl_XeTai;
